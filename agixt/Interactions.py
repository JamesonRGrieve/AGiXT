    ...
    async def format_prompt(
        ...
        **kwargs,
        ...
        with Conversations(conversation_name=conversation_name, user=self.user) as c:
            ...
            conversation_outputs = f"http://localhost:7437/outputs/{self.agent.agent_id}/{conversation_id}/"
            context = []
            ...
            if "conversation_results" in kwargs:
                ...
                try:
                    ...
                    conversation_results = 5
            agent_tasks = self.agent.get_conversation_tasks(
                ...
                if conversation["interactions"] != []:
                    ...
                    for interaction in conversation["interactions"]:
                        if (
                            ...
                            and not str(interaction["message"]).startswith(
                                "[SUBACTIVITY]"
                            )
                        ):
                            timestamp = (
                    ...
                    if to_search:
                        ...
                        try:
                            ...
                            keywords = extract_keywords(
                                text=str(search_strings), limit=5
                            )
                            if keywords:
            ...
            if self.response != "" and self.response != None:
                ...
                if "tts_provider" in agent_settings and tts == True:
                    if (
                        ...
                        try:
                            ...
                            answer = self.response.split("</answer>")[0].split(
                                "<answer>"
                            )[-1]
                ...
                if "image_provider" in agent_settings:
                    if (
                        ...
                        logging.info(
                            f"Image Generation Decision Response: {create_img}"
                        )
